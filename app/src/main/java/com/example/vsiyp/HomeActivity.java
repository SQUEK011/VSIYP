...
import static com.example.vsiyp.ui.mediaeditor.ai.timelapse.AITimeLapseViewModel.STATE_EDIT;
import static com.example.vsiyp.ui.mediaeditor.ai.timelapse.AITimeLapseViewModel.STATE_ERROR;
import static com.example.vsiyp.ui.mediaeditor.ai.timelapse.AITimeLapseViewModel.STATE_NO_SKY_WATER;
...
import com.example.vsiyp.ui.common.adapter.AIListAdapter;
import com.example.vsiyp.ui.common.bean.AIInfoData;
import com.example.vsiyp.ui.common.bean.MediaData;
import com.example.vsiyp.ui.common.utils.ArrayUtils;
...
import com.example.vsiyp.ui.mediaeditor.ai.ObjectSegActivity;
import com.example.vsiyp.ui.mediaeditor.ai.ViewFileActivity;
import com.example.vsiyp.ui.mediaeditor.ai.timelapse.AITimeLapseFragment;
import com.example.vsiyp.ui.mediaeditor.ai.timelapse.AITimeLapseViewModel;
...
public class HomeActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        mTimeLapseViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) factory).get(AITimeLapseViewModel.class);
    ...
    private void initData() {
        HVEAIApplication.getInstance().setApiKey("DAEDAPIVpsDTzvZB856dCzx04h9YnVxNJnm27mm+NIFiDVwnItB2RkU/KPyzbeO+KpIzPNF4AX9a4ghyzh1vFzfhUAIhJCs1Q/NYJg==");
