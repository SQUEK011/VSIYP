...
import static com.example.vsiyp.ui.template.module.activity.TemplateEditActivity.REQUEST_EDIT_CODE;
...
import com.example.vsiyp.ui.common.utils.Utils;
import com.example.vsiyp.ui.common.view.RotationPopupView;
import com.example.vsiyp.ui.common.view.decoration.HorizontalDividerDecoration;
import com.example.vsiyp.ui.common.view.dialog.CommonBottomDialog;
...
import com.example.vsiyp.ui.template.adapter.ModulePickSelectAdapter;
import com.example.vsiyp.ui.template.bean.Constant;
import com.example.vsiyp.ui.template.bean.MaterialData;
import com.example.vsiyp.ui.template.bean.TemplateProjectBean;
import com.example.vsiyp.ui.template.module.activity.TemplateDetailActivity;
import com.example.vsiyp.ui.template.module.activity.VideoModuleDetailActivity;
import com.example.vsiyp.ui.template.utils.CropDataHelper;
import com.example.vsiyp.ui.template.utils.ModuleSelectManager;
import com.example.vsiyp.ui.template.view.dialog.ModuleComposeDialog;
...
public class VideoModulePickFragment extends BaseFragment {
    ...
    private RotationPopupView mPopupWiew;
    ...
    protected void initObject() {
        ...
        ModuleEditViewModel moduleEditViewModel =
            new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(ModuleEditViewModel.class);
    ...
    private void initSpinner() {
        ...
        if (mPopupWiew == null) {
            mPopupWiew = new RotationPopupView(mActivity, rotationList);
            width = mPopupWiew.getPopupWidth();
        } else {
            width = mPopupWiew.getContentView().getMeasuredWidth();
        }

        mPopupWiew.setOnActionClickListener(new RotationPopupView.OnActionClickListener() {
            @Override
