...
import com.example.vsiyp.ui.common.view.decoration.DividerLine;
import com.example.vsiyp.ui.mediaeditor.audio.activity.AudioPickActivity;
import com.example.vsiyp.ui.mediaeditor.audio.adapter.LocalMusicAdapter;
import com.example.vsiyp.ui.mediaeditor.audio.viewmodel.LocalAudioViewModel;
...
public class LocalLocalMusicFragment extends LazyFragment
    ...
    protected void initView(View view) {
        mLocalMusicRecyclerView = view.findViewById(R.id.recycler_view);
    }

    @Override
    protected void initObject() {
        mLocalAudioViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(LocalAudioViewModel.class);
        mLocalMusicRecyclerView.setHasFixedSize(true);
        DefaultItemAnimator itemAnimator = new DefaultItemAnimator();
        itemAnimator.setSupportsChangeAnimations(false);
        mLocalMusicRecyclerView.setItemAnimator(itemAnimator);
        mLocalMusicAdapter = new LocalMusicAdapter(mContext);
        mLocalMusicRecyclerView.setLayoutManager(new LinearLayoutManager(mContext, RecyclerView.VERTICAL, false));
        mLocalMusicRecyclerView.addItemDecoration(DividerLine.getLine(mContext, 16, R.color.color_20));
