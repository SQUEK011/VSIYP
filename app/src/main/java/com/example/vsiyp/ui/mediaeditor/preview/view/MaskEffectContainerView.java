package com.example.vsiyp.ui.mediaeditor.preview.view;

import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.CENTER_RADIUS_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.CENTER_X_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.CENTER_Y_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.DIFF_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.INVERT_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.MASK_HEIGHT_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.MASK_SIZE_RATE_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.MASK_WIDTH_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.ROTATION_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.SCALE_X_KEY;
import static com.huawei.hms.videoeditor.sdk.effect.HVEEffect.SCALE_Y_KEY;
...
public class MaskEffectContainerView extends View implements Observer<Class<? extends MaskShape>> {
    ...
    private void initViewModel() {
        ...
        viewModel = new ViewModelProvider((ViewModelStoreOwner) mCtx, (ViewModelProvider.Factory) mFactory).get(MaskEffectViewModel.class);
