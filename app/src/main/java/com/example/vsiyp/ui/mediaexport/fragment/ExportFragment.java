...
import com.example.vsiyp.ui.mediaexport.model.ExportResult;
import com.example.vsiyp.ui.mediaexport.view.ProgressView;
import com.example.vsiyp.ui.mediaexport.view.SettingView;
...
import com.example.vsiyp.ui.mediaexport.viewmodel.VerificationViewModel;
...
public class ExportFragment extends LazyFragment {
    ...
    private void initViewModel() {
        settingViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(SettingViewModel.class);
        verificationViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(VerificationViewModel.class);
        verificationViewModel.setEditUuid(settingViewModel.getEditUuid());
        exportViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(ExportViewModel.class);
