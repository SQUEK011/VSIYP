...
import com.example.vsiyp.ui.common.adapter.MaskEffectAdapter;
...
import com.example.vsiyp.ui.mediaeditor.preview.MaskEffectOnlineViewModel;
import com.example.vsiyp.ui.mediaeditor.preview.MaskEffectViewModel;
import com.example.vsiyp.ui.mediaeditor.preview.view.CycleMask;
import com.example.vsiyp.ui.mediaeditor.preview.view.FlowerMask;
import com.example.vsiyp.ui.mediaeditor.preview.view.HeartMask;
import com.example.vsiyp.ui.mediaeditor.preview.view.LineMask;
import com.example.vsiyp.ui.mediaeditor.preview.view.ParallelMask;
import com.example.vsiyp.ui.mediaeditor.preview.view.RoundRectMask;
import com.example.vsiyp.ui.mediaeditor.preview.view.StarMask;
...
public class MaskEffectFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        maskEffectOnlineViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(MaskEffectOnlineViewModel.class);
        viewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(MaskEffectViewModel.class);
