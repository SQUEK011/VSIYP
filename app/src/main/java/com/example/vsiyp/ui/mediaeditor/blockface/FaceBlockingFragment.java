...
import com.example.vsiyp.ui.mediaeditor.sticker.viewmodel.StickerItemViewModel;
import com.example.vsiyp.ui.mediaeditor.sticker.viewmodel.StickerPanelViewModel;
import com.example.vsiyp.ui.mediaeditor.trackview.viewmodel.EditPreviewViewModel;
import com.example.vsiyp.ui.mediapick.activity.PicturePickActivity;
...
public class FaceBlockingFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initObject() {
        mStickerPanelViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(StickerPanelViewModel.class);
        mStickerItemViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(StickerItemViewModel.class);
        mFaceBlockingViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(FaceBlockingViewModel.class);
