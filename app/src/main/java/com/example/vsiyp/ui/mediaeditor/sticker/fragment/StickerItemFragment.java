package com.example.vsiyp.ui.mediaeditor.sticker.fragment;
...
import com.example.vsiyp.ui.mediaeditor.sticker.adapter.StickerItemAdapter;
...
public class StickerItemFragment extends BaseFragment {
    ...
    protected void initObject() {
        mStickerPanelViewModel =
                new ViewModelProvider((ViewModelStoreOwner) requireParentFragment(), (ViewModelProvider.Factory) mFactory).get(StickerPanelViewModel.class);
        mStickeritemViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(StickerItemViewModel.class);
    }
