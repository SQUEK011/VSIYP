package com.example.vsiyp.ui.mediaeditor.effect.fragment;
...
import com.example.vsiyp.ui.mediaeditor.effect.adapter.BaseGridLayoutManager;
import com.example.vsiyp.ui.mediaeditor.effect.adapter.EffectItemAdapter;
import com.example.vsiyp.ui.mediaeditor.effect.viewmodel.EffectItemViewModel;
import com.example.vsiyp.ui.mediaeditor.effect.viewmodel.EffectPanelViewModel;
...
public class EffectItemFragment extends BaseFragment {
    ...
    protected void initObject() {
        mEffectPanelViewModel =
                new ViewModelProvider((ViewModelStoreOwner) requireParentFragment(), (ViewModelProvider.Factory) mFactory).get(EffectPanelViewModel.class);
        mEffectItemViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(EffectItemViewModel.class);
    }
