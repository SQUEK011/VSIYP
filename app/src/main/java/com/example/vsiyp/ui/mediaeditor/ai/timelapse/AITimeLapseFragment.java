package com.example.vsiyp.ui.mediaeditor.ai.timelapse;

import static com.example.vsiyp.ui.mediaeditor.ai.timelapse.AITimeLapseViewModel.STATE_BACK_PRESSED;
...
import com.example.vsiyp.ui.common.utils.ScreenBuilderUtil;
import com.example.vsiyp.ui.common.view.EditorTextView;
import com.example.vsiyp.ui.common.view.ScaleBar;
...
public class AITimeLapseFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initObject() {
        aiTimeLapseViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(AITimeLapseViewModel.class);
