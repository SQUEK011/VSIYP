...
import com.example.vsiyp.ui.template.adapter.ModuleEditSelectAdapter;
...
import com.example.vsiyp.ui.template.view.decoration.CenterLayoutManager;
...
import com.example.vsiyp.ui.template.viewmodel.TemplateEditViewModel;
...
public class VideoModuleEditFragment extends BaseFragment implements HuaweiVideoEditor.PlayCallback {
    ...
    protected void initView(View view) {
        mEditViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(TemplateEditViewModel.class);
    ...
    protected void initObject() {
        ...
        mModuleEditViewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity(), (ViewModelProvider.Factory) mFactory).get(ModuleEditViewModel.class);
