...
import com.example.vsiyp.ui.mediaeditor.texts.adapter.TextAnimationItemAdapter;
import com.example.vsiyp.ui.mediaeditor.texts.viewmodel.TextAnimationViewModel;
...
public class EditTextAnimateFragment extends BaseFragment implements AnimationBar.OnProgressChangedListener {
    ...
    protected void initObject() {
        setTimeoutEnable();
        textAnimationViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(TextAnimationViewModel.class);
