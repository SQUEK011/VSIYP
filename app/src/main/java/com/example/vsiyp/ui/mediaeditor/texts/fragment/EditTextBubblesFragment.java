...
import com.example.vsiyp.ui.mediaeditor.texts.adapter.TextBubblesAdapter;
import com.example.vsiyp.ui.mediaeditor.texts.viewmodel.TextBubblesViewModel;
import com.example.vsiyp.ui.mediaeditor.texts.viewmodel.TextPanelViewModel;
...
public class EditTextBubblesFragment extends BaseFragment {
    ...
    protected void initObject() {
        setTimeoutEnable();
        mEditPreviewBubblesViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(EditPreviewViewModel.class);
        ...
        mTextBubblesViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(TextBubblesViewModel.class);
        textPanelViewModel = new ViewModelProvider((ViewModelStoreOwner) mActivity, (ViewModelProvider.Factory) mFactory).get(TextPanelViewModel.class);
