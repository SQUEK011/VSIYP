...
import com.example.vsiyp.ui.mediaeditor.audio.adapter.SoundEffectItemAdapter;
import com.example.vsiyp.ui.mediaeditor.audio.viewmodel.SoundEffectItemViewModel;
import com.example.vsiyp.ui.mediaeditor.audio.viewmodel.SoundEffectViewModel;
...
public class SoundEffectItemFragment extends BaseFragment
    ...
    protected void initObject() {
        ...
        mSoundEffectViewModel =
                new ViewModelProvider((ViewModelStoreOwner) requireParentFragment(), (ViewModelProvider.Factory) mFactory).get(SoundEffectViewModel.class);
        mSoundEffectItemViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(SoundEffectItemViewModel.class);
        mList = new ArrayList<>();
