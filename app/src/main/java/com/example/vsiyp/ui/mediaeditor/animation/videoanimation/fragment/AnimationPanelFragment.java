package com.example.vsiyp.ui.mediaeditor.animation.videoanimation.fragment;
...
import static com.example.vsiyp.ui.mediaeditor.trackview.bean.MainViewState.EDIT_VIDEO_OPERATION_ANIMATION;
import static com.example.vsiyp.ui.mediaeditor.trackview.bean.MainViewState.EDIT_VIDEO_STATE_ANIMATION;
...
import com.example.vsiyp.ui.common.view.AnimationBar;
...
import com.example.vsiyp.ui.common.view.tab.TabTopInfo;
import com.example.vsiyp.ui.common.view.tab.TabTopLayout;
import com.example.vsiyp.ui.mediaeditor.VideoClipsActivity;
import com.example.vsiyp.ui.mediaeditor.animation.videoanimation.adapter.AnimationItemAdapter;
import com.example.vsiyp.ui.mediaeditor.animation.videoanimation.viewmodel.AnimationViewModel;
...
public class AnimationPanelFragment extends BaseFragment implements AnimationBar.OnProgressChangedListener {
    ...
    protected void initObject() {
        ...
        animationViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) mFactory).get(AnimationViewModel.class);
    }
